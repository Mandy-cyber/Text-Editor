 ...
 * the 'Settings' page in the Text Editor app
 */
public class SettingsController extends PageController {
    /**
     * Initializes a new SettingsController with the given page on the given stage
     *
     * @param pageFile a page file
     * @param stage the stage that will be loaded
     */
    public SettingsController(PageFile pageFile, Stage stage) {
