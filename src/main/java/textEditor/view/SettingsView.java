...
import textEditor.controller.SettingsController;

import java.io.IOException;

/**
 * Represents the view of the settings page in the app
 */
public class SettingsView implements PageView {
    private final FXMLLoader loader;

    /**
     * Initializes a SettingsView controlled by the given controller
     *
